//
//  DetailsCheckInMyAccountViewController.m
//  LunchAddict
//
...
@interface DetailsCheckInMyAccountViewController ()

@end

@implementation DetailsCheckInMyAccountViewController
...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration{
    ...
    {
        viewController.presentedFormSheetSize = CGSizeMake(300, 420);
        self.scrollView.contentOffset = CGPointZero;
        [self.scrollView setScrollEnabled:NO];
    }
